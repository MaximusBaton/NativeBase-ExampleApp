...
const datas = [
  ...
  },
  {
    ...
    text: 'PickerWithIcon (iOS only)',
  },
  {
    route: 'PlaceholderPicker',
    text: 'PlaceholderPicker (iOS only)',
  },
  {
    route: 'PlaceholderPickerNote',
    text: 'PlaceholderPickerNote (iOS only)',
  },
  {
    route: 'BackButtonPicker',
    text: 'BackButtonPicker (iOS only)',
  },
  {
    route: 'PickerTextItemText',
    text: 'PickerTextItemText (iOS only)',
  },
  {
    route: 'HeaderPicker',
    text: 'HeaderPicker (iOS only)',
  },
  {
    route: 'HeaderStylePicker',
    text: 'HeaderStylePicker (iOS only)'
  },
  {
    route: "CustomHeaderPicker",
    text: "CustomHeaderPicker (iOS only)"
  },
  {
    route: "PickerWithIconStyle",
    text: "PickerWithIconStyle (iOS only)"
  }
];
