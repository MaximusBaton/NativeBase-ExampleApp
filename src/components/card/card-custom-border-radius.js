...
class NHCardCustomBorderRadius extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header>
          ...
          <Body>
            <Title>Custom BorderRadius</Title>
          </Body>
          <Right />
        </Header>
...
export default connect(mapStateToProps, bindAction)(NHCardCustomBorderRadius);
